...
#             ax.set_ylim(-8, 8)
    ...
    def potato_plot(self, monstations, station, desc, color, dof_xaxis, dof_yaxis, show_hull, show_labels):
    ...
    def  potato_plot_nicely(self, monstations, station, pp, desc, dof_xaxis, dof_yaxis, var_xaxis, var_yaxis):
            self.subplot.cla()
            self.potato_plot(monstations, 
                             station, 
                             desc=station, 
