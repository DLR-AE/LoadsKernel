# -*- coding: utf-8 -*-
"""
Created on Wed Oct 15 09:23:59 2014
...
def isa(h):
    ...
    # but functions for p and T are derived from the US Standard Atmosphere 1976.
    ...
    # beta        = 1.458e-6;     # constant for calculation mu
    # S           = 110.4;        # Sutherland's constant

    # properties of:  troposphere  tropopause            stratosphere
