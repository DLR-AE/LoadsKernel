...
The tests based on the DC3 model are the same as in the public integration tests, but here we
compare to reference results as well. Unfortunately, due to GitHub LFS budget limits, we cannot
provide the reference results publicly.
