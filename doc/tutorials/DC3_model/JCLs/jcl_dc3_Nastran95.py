...
class jcl:
    ...
    def __init__(self):
        ...
        self.geom = {'method': 'mona',  # ModGen and/or Nastran (mona) BDFs
                     ...
                     # Specify the OP2 file containing the matrices Kgg, GM and the uset.
                     'filename_op2': os.path.join(model_root, 'fem', 'Nast95_structure_only.op2'),
                     }
        ...
        self.mass = {'method': 'Nastran95',  # Use new Nastran 95 interface
                     'key': ['M3'],
                     # MGG via DMAP Alter and OP2
                     'filename_op2': [os.path.join(model_root, 'fem', 'Nast95_M3.op2')],
