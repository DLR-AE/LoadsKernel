...
#         return dcommand
    ...
    def fmu_init(self, filename, command_0, setpoint_v, setpoint_theta ):
        ...
        """
        Die meisten Signale sollten aus dem xml selbsterklärend sein, die Outputs sind [elevator, rudder, throttle_l, throttle_r]
        TECS_OnOFF ist ein boolean, wenn off dann ist NUR Theta CMD aktiv in der Längsachse, wenn on dann ist gamma_cmd und v_cmd (EAS) aktiv.
