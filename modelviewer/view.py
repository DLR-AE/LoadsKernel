...
class Modelviewer():
    ...
    def run(self):
        # Use existing QApplication or create a new one
    ...
    def initWindowAndMenu(self, container):
    ...
    def load_tau_grid(self):
        filename = QtWidgets.QFileDialog.getOpenFileName(self.window, self.nc_opt['title'],
