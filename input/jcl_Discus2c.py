...
class jcl:
    def __init__(self):
        ...
        self.trimcase = [{'desc': 'Elev3211_B', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'segelflug',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.097,            # Mach number
                          'aero': 'VC',         # aero key
