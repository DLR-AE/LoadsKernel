...
class jcl:
    def __init__(self):
        ...
        self.mass = {'method': 'mona',
                       'key': ['M', 'BFDM'],
                       #'filename_MAA':['/scratch/DLR-F19-S_150217/assembly_DLR-F-19-S/matrix_export/MAA_M.dat'],
                       'filename_S103':['/scratch/DLR-F19-S_150217/assembly_DLR-F-19-S/nastran/assembly_SOL103_M.f06', 
                                        '/scratch/DLR-F19-S_150217/assembly_DLR-F-19-S/nastran/assembly_SOL103_BFDM.f06',
                                       ], 
                       'omit_rb_modes': True, 
