...
class jcl:
    def __init__(self):
        ...
        self.aero = {'method': 'mona_unsteady', # 'mona_steady' or 'hybrid'
                     ...
                     'method_AIC': 'dlm', # 'vlm' or 'nastran'
                     'key':['M015'],
                     'Ma': [0.15],
                     'k_red': [ 0.01, 0.03, 0.1, 0.25, 0.5, 0.75, 1.0, 1.25 ], # Nastran Definition!
                     'n_poles': 4,
                    }
        ...
        self.trimcase = [{'desc': 'CC.M1.OM015FL000.M000', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.0001,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M005', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.05,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M01', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.1,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M011', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.11,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M012', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.12,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M013', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.13,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M014', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.14,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M015', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.15,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M016', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.16,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M017', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.17,            # Mach number
                          'aero': 'M015',         # aero key
                         ...
                         {'desc': 'CC.M1.OM015FL000.M018', # description of maneuver case, e.g. according to G. Pinho Chiozzotto, "Kriterien fuer die Erstellung eines Lastenkatalogs," Institute of Aeroelasticity, iLOADs MS1.2, Feb. 2014.
                          'manoeuver': 'pitch',      # unused
                          'subcase': 1,        # ID number
                          'Ma': 0.18,            # Mach number
                          'aero': 'M015',         # aero key
